...
final CollectionReference transactionsRef =
    firestore.collection('Transactions').withConverter<TransactionInfo>(
          fromFirestore: (snapshot, _) =>
              TransactionInfo.fromJson(snapshot.data()!),
...
final CollectionReference categoriesRef = firestore
