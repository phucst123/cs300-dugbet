  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<WalletPersonalController>(
        ...
        builder: (controller) {
          ...
          return InkWell(
            onTap: () =>
                Get.toNamed(AppPage.walletDetail, arguments: walletData),
            child: Center(
              child: Stack(
                ...
                children: [
                  ...
                  Positioned(
                      ...
                      child: Row(
                        children: [
                          Text(convertToCurrency(controller.balance.value + walletData.initialAmount),
                              style: TextThemeBuilder
                                  .robotoTextTheme.displaySmall),
                          SvgPicture.asset(
                  ...
                  Positioned(
                    ...
                    child: Row(
                      children: [
                        Text(convertToCurrency(controller.displayIncome.value),
                            style:
                  ...
                  Positioned(
                    ...
                    child: Row(
                      children: [
                        Text(convertToCurrency(controller.displayExpense.value),
                            style:
                                TextThemeBuilder.robotoTextTheme.titleMedium),
                        SvgPicture.asset(
                          "assets/images/dIcon.svg",
